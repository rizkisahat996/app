...
<body class="px-2 " onload="window.print()">
    <div>
        ...
        <div>
            ...
            <p style="height: 5px">Desa Manunggal Kec. Labuhan Deli Kab. Deli Serdang - Sumut</p>
        </div>
    </div>
    ...
    <table class="table table-borderless" id="barang" style="width: 100%; height:100px">
        ...
        <tfoot>
            <tr class="">
                ...
                <td></td>
                <td></td>
                <td id="total" class="text-start fw-semibold" style="text-align: center;font-weight:500">Jumlah
                    Total&nbsp;:</td>
            ...
            <tr class="">
                ...
                <td></td>
                <td></td>
                <td id="bayar" class="text-start fw-semibold" style="text-align: center;font-weight:500">Bayar&nbsp;:
                </td>
            ...
            <tr class="">
                ...
                <?php
                    ...
                    $haha = -$oke;
                ?>
                <td id="sisa" class="text-start fw-semibold" style="text-align: center;font-weight:500">Belum
                    Bayar&nbsp;:</td>
