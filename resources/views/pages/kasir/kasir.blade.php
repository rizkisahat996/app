...
@section('content')
    ...
    <div class="container">
        <div style="background-color: #273248; border-radius: 5px; box-shadow: 1em; color: white; font-size: 1.3rem" class="mb-3 py-3 px-4 col-12 col-md-6 col-lg-4 mx-auto">
        ...
        <div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 5px" class="bg-white py-5 px-5">
          ...
          <form>
            <div class="d-flex flex-wrap gap-3 justify-content-center align-items-center pb-5">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="d-flex justify-content-center gap-3">
                    <a target="_blank" href="/preview/{{ $item->id }}">
