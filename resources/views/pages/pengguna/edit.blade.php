...
@section('content')
    ...
    <div>
      ...
      <form action="/pengguna/{{ $data->id }}" method="post" enctype="multipart/form-data" class="bg-white px-4 py-4" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 5px">
          @csrf
          @method('put')
          <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Nama Pengguna</label>
              <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="name" value="{{ old('name', $data->name) }}">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="inputPassword5" class="form-label">Masukkan Password Baru</label>
